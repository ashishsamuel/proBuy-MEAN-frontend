    ...
    this.payPalConfig = {
        ...
        onClientAuthorization: (data) => {
            ...
            this.api.emptyCartAPI().subscribe((res:any)=>{
              ...
              this.toaster.showSuccess("Successfully completed the payment... Thankyou for ordering with us!!!")
              this.proceedToBuyStatus = false
        ...
        onError: err => {
            ...
            this.toaster.showWarning("Transaction failed Please try after some time")
            this.proceedToPaymentStatus = false
        },
